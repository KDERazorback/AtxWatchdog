...
echo "atxdump..."
copy /y "AtxDataDumper\bin\%build_type%\*" "%output_path%\%build_type%\"
echo "atxcsv..."
copy /y "atxcsvdataconverter\bin\%build_type%\*" "%output_path%\%build_type%\"
echo "atxcsvplotter..."
copy /y "atxcsvplotter\bin\%build_type%\*" "%output_path%\%build_type%\"
echo "atxcsvanalyzer..."
copy /y "AtxCsvAnalyzer\bin\%build_type%\*" "%output_path%\%build_type%\"
