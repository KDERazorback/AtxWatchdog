    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            if (args == null || args.Length < 1)
            {
                ...
                Console.WriteLine("       atxcsvplot.exe png <file1.csv> ... [fileN.csv] [/config=file.xml] [/background=#aarrggbb] [/dpi=xxx]");
                Console.WriteLine("                          [/axes=<name1>,<name2>] [/norun] [/metadata=[file1],[file2]...[fileN] [/nometadata]");
                Console.WriteLine();
                ...
                Console.WriteLine("   Skips plotting metadata to the outputs");
